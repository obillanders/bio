...
class __TwigTemplate_943bfed7976057b45928f8ef0a17f8010e73bc4a71d458891b5e39b18f5b283d extends Twig_Template
{
    ...
    public function block_content($context, array $blocks = array())
    {
        ...
        echo "</h3>
            ...
            <div class=\"box-body\">
                ";
        // line 28
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("message_delete_confirmation", array("%object%" => $this->getAttribute(($context["admin"] ?? null), "toString", array(0 => ($context["object"] ?? null)), "method")), "SonataAdminBundle"), "html", null, true);
        echo "
            </div>
        ...
        echo "</button>
                    ";
        // line 36
        if (($this->getAttribute(($context["admin"] ?? null), "hasRoute", array(0 => "edit"), "method") && $this->getAttribute(($context["admin"] ?? null), "hasAccess", array(0 => "edit", 1 => ($context["object"] ?? null)), "method"))) {
            // line 37
            echo "                        ";
...
";
    ...
    {
        return new Twig_Source("", "SonataAdminBundle:CRUD:delete.html.twig", "/var/www/html/bio/vendor/sonata-project/admin-bundle/Resources/views/CRUD/delete.html.twig");
    }
}
