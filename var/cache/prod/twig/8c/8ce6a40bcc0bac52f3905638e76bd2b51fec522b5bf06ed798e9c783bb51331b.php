...
class __TwigTemplate_02372b6d4e92812b4886fd984dfac95096e936489deac734f248c7629591433c extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        if ( !$this->getAttribute($this->getAttribute(($context["sonata_admin"] ?? null), "field_description", array()), "hasassociationadmin", array())) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["element"]) {
                // line 13
                echo "        ";
                echo twig_escape_filter($this->env, $this->env->getExtension('Sonata\AdminBundle\Twig\Extension\SonataAdminExtension')->renderRelationElement($context["element"], $this->getAttribute(($context["sonata_admin"] ?? null), "field_description", array())), "html", null, true);
                echo "
    ";
            }
    ...
    <div id=\"field_container_";
        ...
        <span id=\"field_widget_";
            ...
            if (($this->getAttribute(($context["sonata_admin"] ?? null), "edit", array()) == "inline")) {
                ...
                if (($this->getAttribute(($context["sonata_admin"] ?? null), "inline", array()) == "table")) {
                    ...
                    // line 24
                    echo "                ";
                } elseif ((twig_length_filter($this->env, $this->getAttribute(($context["form"] ?? null), "children", array())) > 0)) {
                    // line 25
                    echo "                    ";
        ...
        ";
            // line 35
            $context["display_create_button"] = ((($this->getAttribute($this->getAttribute($this->getAttribute(($context["sonata_admin"] ?? null), "field_description", array()), "associationadmin", array()), "hasroute", array(0 => "create"), "method") && $this->getAttribute($this->getAttribute($this->getAttribute(            // line 36
($context["sonata_admin"] ?? null), "field_description", array()), "associationadmin", array()), "isGranted", array(0 => "CREATE"), "method")) &&             // line 37
($context["btn_add"] ?? null)) && ( !$this->getAttribute($this->getAttribute($this->getAttribute(            // line 39
...
($context["form"] ?? null), "children", array())) < $this->getAttribute($this->getAttribute($this->getAttribute(($context["sonata_admin"] ?? null), "field_description", array()), "options", array()), "limit", array()))));
            // line 42
            echo "
        ";
            // line 43
            ...
            ";
                ...
                if (($context["display_create_button"] ?? null)) {
                    ...
                    <a
                        href=\"";
                    // line 48
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute(($context["sonata_admin"] ?? null), "field_description", array()), "associationadmin", array()), "generateUrl", array(0 => "create", 1 => $this->getAttribute($this->getAttribute(                    // line 50
        ...
        ";
                ...
                if (($context["display_create_button"] ?? null)) {
                    ...
                    echo "                    <a
                        href=\"";
                    // line 78
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute(($context["sonata_admin"] ?? null), "field_description", array()), "associationadmin", array()), "generateUrl", array(0 => "create", 1 => $this->getAttribute($this->getAttribute(                    // line 80
($context["sonata_admin"] ?? null), "field_description", array()), "getOption", array(0 => "link_parameters", 1 => array()), "method")), "method"), "html", null, true);
                    // line 81
                    echo "\"
...
";
    ...
    {
        return new Twig_Source("", "SonataDoctrineORMAdminBundle:CRUD:edit_orm_one_to_many.html.twig", "/var/www/html/bio/vendor/sonata-project/doctrine-orm-admin-bundle/Resources/views/CRUD/edit_orm_one_to_many.html.twig");
    }
}
