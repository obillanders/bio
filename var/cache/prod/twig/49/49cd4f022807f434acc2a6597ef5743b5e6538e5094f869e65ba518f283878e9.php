...
class __TwigTemplate_f5f3fe1206dbd18653ea69793fb759a69b0efdfc586f7cbbf696a0101a1cb909 extends Twig_Template
{
    ...
    public function block_list_table($context, array $blocks = array())
    {
        ...
        <div class=\"box box-primary\">
            <div class=\"box-header\">
                <h1 class=\"box-title\">
                    ";
        // line 53
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("element.tree_site_label", array(), $this->getAttribute(($context["admin"] ?? null), "translationdomain", array())), "html", null, true);
        echo "
                    <div class=\"btn-group\">
                        <button type=\"button\" class=\"btn btn-default dropdown-toggle\" data-toggle=\"dropdown\">
                            <strong class=\"text-info\">";
        // line 56
        echo twig_escape_filter($this->env, $this->getAttribute(($context["currentSite"] ?? null), "name", array()), "html", null, true);
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["context"]) {
            ...
            echo "                                <li>
                                    <a href=\"";
            // line 61
            echo twig_escape_filter($this->env, $this->getAttribute(($context["admin"] ?? null), "generateUrl", array(0 => "tree", 1 => array("context" => $this->getAttribute($context["context"], "id", array()))), "method"), "html", null, true);
            echo "\">
                                        ";
            // line 62
            if ((($context["currentContext"] ?? null) && ($this->getAttribute($context["context"], "id", array()) == $this->getAttribute(($context["currentContext"] ?? null), "id", array())))) {
                // line 63
        ...
        echo "                        </ul>
            ...
            <div class=\"box-content\">
                ";
        // line 76
        echo $context["tree"]->getnavigate_child(($context["collection"] ?? null), ($context["admin"] ?? null), true);
        echo "
            </div>
        </div>
    </div>
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["element"]) {
                ...
                ";
                    ...
                    if (twig_length_filter($this->env, $this->getAttribute($context["element"], "children", array()))) {
                        // line 33
                        echo "                    ";
                        echo $this->getAttribute($this, "navigate_child", array(0 => $this->getAttribute($context["element"], "children", array()), 1 => ($context["admin"] ?? null), 2 => false), "method");
                        echo "
                ";
                    }
                    // line 35
...
";
    ...
    {
        return new Twig_Source("", "SonataAdminBundle:CRUD:tree.html.twig", "/var/www/html/bio/vendor/sonata-project/admin-bundle/Resources/views/CRUD/tree.html.twig");
    }
}
