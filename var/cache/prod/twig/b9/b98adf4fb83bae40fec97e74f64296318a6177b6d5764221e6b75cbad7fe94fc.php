...
class __TwigTemplate_d81cd159785b50f2da1fc53b457b29dbc8b2883d59cc1311099947c8253af492 extends Twig_Template
{
    ...
    public function getrender_form($__form__ = null, $__permissions__ = null, $__td_type__ = null, $__admin__ = null, $__admin_pool__ = null, $__object__ = null, ...$__varargs__)
    {
        ...
        try {
          ...
          ";
            ...
            ";
            // line 17
            if ( !$this->getAttribute(($context["admin_pool"] ?? null), "getOption", array(0 => "html5_validate"), "method")) {
        ...
        <div class=\"box box-success\">
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["child"]) {
                if (($this->getAttribute($this->getAttribute($context["child"], "vars", array()), "name", array()) != "_token")) {
                    ...
                    // line 45
                    echo "                                ";
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["typeChild"] ?? null), "vars", array()), "value", array()), "html", null, true);
                    echo "
                                ";
                    // line 46
                    echo $this->env->getRuntime('Symfony\Bridge\Twig\Form\TwigRenderer')->searchAndRenderBlock(($context["typeChild"] ?? null), 'widget');
                    echo "
                            </td>
                            ";
                    // line 48
        ...
        ";
            // line 57
            echo $this->env->getRuntime('Symfony\Bridge\Twig\Form\TwigRenderer')->searchAndRenderBlock($this->getAttribute(($context["form"] ?? null), "_token", array()), 'row');
            echo "
...
";
    ...
    {
        return new Twig_Source("", "SonataAdminBundle:CRUD:base_acl_macro.html.twig", "/var/www/html/bio/vendor/sonata-project/admin-bundle/Resources/views/CRUD/base_acl_macro.html.twig");
    }
}
