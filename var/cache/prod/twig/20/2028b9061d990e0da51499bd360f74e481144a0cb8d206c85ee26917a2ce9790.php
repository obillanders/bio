...
class __TwigTemplate_4d8acfc4879e3df82b6a0469fa69b0b9e2eaa0844ac4875adf565e8c0410e169 extends Twig_Template
{
...
($context["sonata_admin"] ?? null), "field_description", array(), "any", false, true), "options", array(), "any", false, true), "placeholder", array(), "any", true, true) && $this->getAttribute($this->getAttribute($this->getAttribute(($context["sonata_admin"] ?? null), "field_description", array()), "options", array()), "placeholder", array()))) {
        ...
        // line 113
        echo "            ";
        echo $this->env->getRuntime('Symfony\Bridge\Twig\Form\TwigRenderer')->searchAndRenderBlock(($context["form"] ?? null), 'widget', array("required" => false));
        echo "
        </span>
...
($context["sonata_admin"] ?? null), "field_description", array()), "mappingtype", array()) == twig_constant("Doctrine\\ORM\\Mapping\\ClassMetadataInfo::MANY_TO_MANY"))) {
    ...
    {
        return new Twig_Source("", "SonataDoctrineORMAdminBundle:Form:form_admin_fields.html.twig", "/var/www/html/bio/vendor/sonata-project/doctrine-orm-admin-bundle/Resources/views/Form/form_admin_fields.html.twig");
    }
}
