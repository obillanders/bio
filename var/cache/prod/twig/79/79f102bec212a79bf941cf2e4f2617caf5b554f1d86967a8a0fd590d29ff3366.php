...
class __TwigTemplate_fdde25b2d76783e762a6d8a3e10cfdadfae8dae00cafc783c4951b57d100058e extends Twig_Template
{
    ...
    {
        // line 12
        return $this->loadTemplate(($context["base_template"] ?? null), "SonataAdminBundle:CRUD:base_history.html.twig", 12);
    }
    ...
    <div class=\"row\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["revision"]) {
            // line 36
            echo "                            <tr class=\"";
            if (((($context["currentRevision"] ?? null) != false) && ($this->getAttribute($context["revision"], "rev", array()) == $this->getAttribute(($context["currentRevision"] ?? null), "rev", array())))) {
            ...
            echo "</td>
                                <td>";
            // line 38
            $this->loadTemplate($this->getAttribute(($context["admin"] ?? null), "getTemplate", array(0 => "history_revision_timestamp"), "method"), "SonataAdminBundle:CRUD:base_history.html.twig", 38)->display($context);
            echo "</td>
                                <td>";
            // line 39
            ...
            echo "</td>
                                <td><a href=\"";
            // line 40
            echo twig_escape_filter($this->env, $this->getAttribute(($context["admin"] ?? null), "generateObjectUrl", array(0 => "history_view_revision", 1 => ($context["object"] ?? null), 2 => array("revision" => $this->getAttribute($context["revision"], "rev", array()))), "method"), "html", null, true);
            ...
            if (((($context["currentRevision"] ?? null) == false) || ($this->getAttribute($context["revision"], "rev", array()) == $this->getAttribute(($context["currentRevision"] ?? null), "rev", array())))) {
                ...
                // line 45
                echo "                                        <a href=\"";
                echo twig_escape_filter($this->env, $this->getAttribute(($context["admin"] ?? null), "generateObjectUrl", array(0 => "history_compare_revisions", 1 => ($context["object"] ?? null), 2 => array("base_revision" => $this->getAttribute(($context["currentRevision"] ?? null), "rev", array()), "compare_revision" => $this->getAttribute($context["revision"], "rev", array()))), "method"), "html", null, true);
...
";
    ...
    {
        return new Twig_Source("", "SonataAdminBundle:CRUD:base_history.html.twig", "/var/www/html/bio/vendor/sonata-project/admin-bundle/Resources/views/CRUD/base_history.html.twig");
    }
}
