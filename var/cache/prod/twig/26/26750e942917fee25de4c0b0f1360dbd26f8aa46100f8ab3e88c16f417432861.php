...
class __TwigTemplate_8d7043dffcc204bd60f496b59e49ce8b4d7b0125104bf4387ab440ff9096e06e extends Twig_Template
{
            ...
            foreach ($context['_seq'] as $context["name"] => $context["form_group"]) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["field_name"]) {
                    ...
                    if ($this->getAttribute($this->getAttribute(($context["associationAdmin"] ?? null), "formfielddescriptions", array(), "any", false, true), $context["field_name"], array(), "array", true, true)) {
                        // line 41
                        echo "                                                ";
                        echo $this->env->getRuntime('Symfony\Bridge\Twig\Form\TwigRenderer')->searchAndRenderBlock(($context["nested_field"] ?? null), 'row', array("inline" => "natural", "edit" => "inline"));
                        // line 44
                        echo "
                                                ";
                        // line 45
                        ...
                        // line 47
                        echo "                                                ";
                        echo $this->env->getRuntime('Symfony\Bridge\Twig\Form\TwigRenderer')->searchAndRenderBlock(($context["nested_field"] ?? null), 'row');
                        echo "
                                            ";
                    }
                    // line 49
...
";
    ...
    {
        return new Twig_Source("", "SonataDoctrineORMAdminBundle:CRUD:edit_orm_one_to_many_inline_tabs.html.twig", "/var/www/html/bio/vendor/sonata-project/doctrine-orm-admin-bundle/Resources/views/CRUD/edit_orm_one_to_many_inline_tabs.html.twig");
    }
}
