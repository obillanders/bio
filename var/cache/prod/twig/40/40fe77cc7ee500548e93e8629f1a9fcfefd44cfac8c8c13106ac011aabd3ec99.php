...
class __TwigTemplate_7477e44fb82297e73a19d7510c14514fddfba44f00239666d9a5d8c290ac709b extends Twig_Template
{
    ...
    <div class=\"sf-toolbar-block\">
        ...
        if ((($context["profiler_markup_version"] ?? null) == 1)) {
            ...
            // line 11
            echo twig_escape_filter($this->env, $this->getAttribute(($context["collector"] ?? null), "getTotalBlock", array(), "method"), "html", null, true);
            echo "</span> blocks
                </a>
            </div>
        ";
        ...
        <div class=\"sf-toolbar-info\">
            <div class=\"sf-toolbar-info-piece\">
                ...
                <span>";
        // line 26
        echo twig_escape_filter($this->env, twig_length_filter($this->env, $this->getAttribute(($context["collector"] ?? null), "realBlocks", array())), "html", null, true);
        echo "</span>
            </div>
            <div class=\"sf-toolbar-info-piece\">
                <b>Containers</b>
                <span>";
        // line 30
        echo twig_escape_filter($this->env, twig_length_filter($this->env, $this->getAttribute(($context["collector"] ?? null), "containers", array())), "html", null, true);
        echo "</span>
            </div>
            ";
        // line 32
        ...
        echo "                <b>Events</b>
                <span>";
        // line 43
        echo twig_escape_filter($this->env, twig_length_filter($this->env, $this->getAttribute(($context["collector"] ?? null), "events", array())), "html", null, true);
        echo "</span>
            </div>
        </div>
    </div>
";
    ...
    public function block_menu($context, array $blocks = array())
    {
        ...
        <strong>Blocks";
        // line 54
        if ((twig_length_filter($this->env, $this->getAttribute(($context["collector"] ?? null), "events", array())) > 0)) {
            echo "<strong>*</strong>";
        }
        echo "</strong>
        <span class=\"count\">
...
";
    ...
    <table>
        ...
        $context['_seq'] = twig_ensure_traversable($this->getAttribute(($context["collector"] ?? null), "events", array()));
    ...
    ";
        // line 97
        $context["blocks"] = $this->getAttribute(($context["collector"] ?? null), "realBlocks", array());
        // line 98
        echo "    ";
        if ((($context["profiler_markup_version"] ?? null) == 1)) {
            // line 99
    ...
    ";
        // line 107
        $context["blocks"] = $this->getAttribute(($context["collector"] ?? null), "containers", array());
        // line 108
        echo "    ";
        if ((($context["profiler_markup_version"] ?? null) == 1)) {
            // line 109
...
";
    ...
    {
        return new Twig_Source("", "SonataBlockBundle:Profiler:block.html.twig", "/var/www/html/bio/vendor/sonata-project/block-bundle/Resources/views/Profiler/block.html.twig");
    }
}
