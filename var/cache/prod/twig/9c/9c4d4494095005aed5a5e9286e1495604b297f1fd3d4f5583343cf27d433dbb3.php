...
class __TwigTemplate_fdfa68564097a3fdf558b378545051d8b4f04bd8db755bdaf7211af0c67cdd12 extends Twig_Template
{
...
";
        // line 12
        if (($this->getAttribute(($context["admin"] ?? null), "hasAccess", array(0 => "delete", 1 => ($context["object"] ?? null)), "method") && $this->getAttribute(($context["admin"] ?? null), "hasRoute", array(0 => "delete"), "method"))) {
            // line 13
            echo "    <a href=\"";
...
";
    ...
    {
        return new Twig_Source("", "SonataAdminBundle:CRUD:list__action_delete.html.twig", "/var/www/html/bio/vendor/sonata-project/admin-bundle/Resources/views/CRUD/list__action_delete.html.twig");
    }
}
