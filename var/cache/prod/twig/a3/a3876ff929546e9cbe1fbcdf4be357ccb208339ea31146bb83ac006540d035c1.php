...
class __TwigTemplate_e15f2b249dafcd91327dccff6642d71eb74b807cd78b9444b5a03b16850f7225 extends Twig_Template
{
                ...
                <div class=\"box-body\">
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["field_name"]) {
                        if ($this->getAttribute($this->getAttribute(($context["admin"] ?? null), "formfielddescriptions", array(), "any", false, true), $context["field_name"], array(), "array", true, true)) {
                            // line 21
                            echo "                            ";
                            echo $this->env->getRuntime('Symfony\Bridge\Twig\Form\TwigRenderer')->searchAndRenderBlock($this->getAttribute(($context["form"] ?? null), $context["field_name"], array(), "array"), 'row');
                            echo "
                        ";
...
";
    ...
    {
        return new Twig_Source("", "SonataAdminBundle:CRUD:base_edit_form_macro.html.twig", "/var/www/html/bio/vendor/sonata-project/admin-bundle/Resources/views/CRUD/base_edit_form_macro.html.twig");
    }
}
