...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'monolog.handler.app_hipchat' => 'getMonolog_Handler_AppHipchatService',
    ...
    {
        return $this->services['app.manager_tools'] = new \AppBundle\Service\ManagerTools($this->get('doctrine'), $this->get('app.result_factory'), $this->get('validator'), $this->get('monolog.logger.doctrine'), $this->get('event_dispatcher'));
    }
    ...
    {
        return $this->services['app.user.password_helper'] = new \AppBundle\Service\UserPasswordHelper($this->get('event_dispatcher'), $this->get('fos_user.util.token_generator'), 7200);
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('pG6SO6L2Ty', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('CR8RFUm117', 0, 'olROkTALurdnmMdd2F-35G', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $b->setSQLLogger(new \Symfony\Bridge\Doctrine\Logger\DbalLogger($this->get('monolog.logger.doctrine', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('debug.stopwatch', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
        ...
        $e->addResolveTargetEntity('Shapecode\\Bundle\\CronBundle\\Entity\\Interfaces\\CronJobInterface', 'Shapecode\\Bundle\\CronBundle\\Entity\\CronJob', array());
        $e->addResolveTargetEntity('Shapecode\\Bundle\\CronBundle\\Entity\\Interfaces\\CronJobResultInterface', 'Shapecode\\Bundle\\CronBundle\\Entity\\CronJobResult', array());
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'biowebpro', 'user' => 'root', 'password' => '1Jbgub18', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $f, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_40c848330788dc7642237a526c55c0601c3ca38b8a9ec7fa685938ede9aca858');
    ...
    {
        return $this->services['fos_rest.serializer.exception_normalizer.jms'] = new \FOS\RestBundle\Serializer\Normalizer\ExceptionHandler(new \FOS\RestBundle\Util\ExceptionValueMap(array('AppBundle\\Exception\\ApiException' => true)), false);
    }
    ...
    {
        return $this->services['fos_user.util.user_manipulator'] = new \FOS\UserBundle\Util\UserManipulator($this->get('app.manager.user'), $this->get('event_dispatcher'), $this->get('request_stack'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \EightPoints\Bundle\GuzzleBundle\Log\DevNullLogger A EightPoints\Bundle\GuzzleBundle\Log\DevNullLogger instance
     */
    protected function getGuzzleBundle_LoggerService()
    {
        return $this->services['guzzle_bundle.logger'] = new \EightPoints\Bundle\GuzzleBundle\Log\DevNullLogger();
    }
    ...
    {
        return $this->services['guzzle_bundle.middleware.event_dispatch.api_biogaran_rdi'] = new \EightPoints\Bundle\GuzzleBundle\Middleware\EventDispatchMiddleware($this->get('event_dispatcher'), 'api_biogaran_rdi');
    }
    ...
    {
        return $this->services['lexik_maintenance.listener'] = new \Lexik\Bundle\MaintenanceBundle\Listener\MaintenanceListener($this->get('lexik_maintenance.driver.factory'), NULL, NULL, NULL, array(), array(), NULL, array(), 503, 'Service Temporarily Unavailable', false);
    }
    ...
    protected function getLoggerService()
    {
        ...
        $instance->pushHandler($this->get('monolog.handler.app_hipchat'));
    ...
    /*
     * Gets the 'monolog.handler.app_hipchat' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Monolog\Handler\HipChatHandler A Monolog\Handler\HipChatHandler instance
     */
    protected function getMonolog_Handler_AppHipchatService()
    {
        $this->services['monolog.handler.app_hipchat'] = $instance = new \Monolog\Handler\HipChatHandler('ac45bc4d7e00ba3004813945017ba9', 1696448, 'Monolog', false, 400, true, true, 'html', 'api.hipchat.com', 'v1');
    ...
    {
        $this->services['monolog.handler.app_main_log'] = $instance = new \Monolog\Handler\StreamHandler(($this->targetDirs[2].'/logs/app/app_prod.log'), 200, true, NULL);
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('j1-csIoPiN', NULL, 'olROkTALurdnmMdd2F-35G', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    {
        return $this->services['sonata.formatter.form.type.selector'] = new \Sonata\FormatterBundle\Form\Type\FormatterType($this->get('sonata.formatter.pool'), $this->get('translator.default'), $this->get('ivory_ck_editor.config_manager'), $this->get('ivory_ck_editor.plugin_manager'), $this->get('ivory_ck_editor.template_manager'));
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('GT5r2CFqKJ', 0, 'olROkTALurdnmMdd2F-35G', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['cache.serializer'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Fa8eDQJLXY', 0, 'olROkTALurdnmMdd2F-35G', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Y1-zbr9wPk', 0, 'olROkTALurdnmMdd2F-35G', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['debug.file_link_formatter'] = new \Symfony\Component\HttpKernel\Debug\FileLinkFormatter('phpstorm://open?file=%f&line=%l');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'monolog.handlers_to_channels' => array(
                'monolog.handler.app_hipchat' => NULL,
