 ...
 */
class Tag extends \AppBundle\Entity\Classification\Tag implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'slug', 'createdAt', 'updatedAt', 'enabled', 'context'];
        }
